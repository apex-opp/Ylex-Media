    ...
    <div className="pointer-events-none fixed inset-0 z-[5] opacity-60">
      ...
      >
        ...
        <g ref={dotsRef} opacity="0">
          <circle cx="420" cy="60" r="6" fill="rgba(106,228,255,0.35)" />
          <circle cx="560" cy="130" r="6" fill="rgba(106,228,255,0.28)" />
          <circle cx="560" cy="520" r="6" fill="rgba(255,106,139,0.30)" />
          <circle cx="780" cy="630" r="6" fill="rgba(106,228,255,0.26)" />
          <circle cx="580" cy="950" r="6" fill="rgba(155,255,106,0.22)" />
          <circle cx="580" cy="1210" r="6" fill="rgba(106,228,255,0.26)" />
          <circle cx="880" cy="1350" r="6" fill="rgba(255,106,139,0.24)" />
          <circle cx="620" cy="1760" r="6" fill="rgba(106,228,255,0.30)" />
        </g>
