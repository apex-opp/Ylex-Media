...
export default function WireframeGrid() {
  ...
  useEffect(() => {
    ...
    const draw = (t) => {
      ...
      ctx.strokeStyle = "rgba(214,228,255,0.05)";
      ctx.lineWidth = 1;
      ctx.beginPath();
      ...
      ctx.strokeStyle = "rgba(214,228,255,0.09)";
      ctx.lineWidth = 1;
      ctx.beginPath();
      ...
      ctx.fillStyle = "rgba(106,228,255,0.14)";
      const dotStep = 96;
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0">
      ...
      <div className="absolute inset-0 bg-grid-faint-24 opacity-80" />
      <div className="absolute inset-0 bg-grid-64 opacity-55" />
