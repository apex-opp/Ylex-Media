...
export default function WireframeViewport({ className = "" }) {
  ...
  useEffect(() => {
    ...
    const drawFrame = (t) => {
      ...
      const stroke = "rgba(214,228,255,0.55)";
      const glow = "rgba(106,228,255,0.14)";
      ...
      // coordinates text
      ctx.fillStyle = "rgba(214,228,255,0.50)";
  ...
  return (
    <div className={className}>
      <div className="relative overflow-hidden rounded-lg border border-blueprint-line bg-blueprint-bg/60 shadow-wire backdrop-blur-sm">
        ...
        <canvas
          ...
          data-magnet="0.2"
        />
        <div className="pointer-events-none absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-blueprint-neon/35 to-transparent" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[1px] bg-gradient-to-r from-transparent via-blueprint-warn/25 to-transparent" />
      </div>

      <div className="mt-3 flex flex-wrap items-center justify-between gap-2 font-mono text-[10px] tracking-[0.24em] text-blueprint-ink/55">
